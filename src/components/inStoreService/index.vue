        ...
        <view class="in-store-service__nav-bar-content">
          <view class="location-container">
            <view class="cur-location">
              ...
              <text
                v-else-if="permission === LocationPermissionStatus.GRANTED && isLocationFinished || isManualCitySwitch || isFromSelectPositionCityPage"
                class="location-name"
...
export default {
  ...
  methods: {
    ...
    async fetchHasShopCityListData () {
      ...
      this.cityList = resp.data.data.sort((a, b) => a.distance - b.distance)|| []
    },
    // 获取资源区数据
